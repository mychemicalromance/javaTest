...
public class TestNew {
	public static void main(String[] args) {
        ...
        prop.setProperty("eureka.client.registry-fetch-interval-seconds", "10");//#生产环境上，这个值得设为30
        prop.setProperty("eureka.client.initial-instance-info-replication-interval-seconds", "5");//#生产环境上，这个值得设为10
        ...
        prop.setProperty("platform.httpClient.maxTotal", "122");
